...
| **009: Streamlined Release Workflow (Tag & Cmd Triggered)** | [`specs/009-streamlined-git-release-workflow.md`](../specs/009-streamlined-git-release-workflow.md) | [`plans/009-streamlined-git-release-workflow.md`](009-streamlined-git-release-workflow.md) | IN_PROGRESS | - | @antigravity |
