...
def main():
    parser = argparse.ArgumentParser(
        description="Autonomous AI Code Review & Security Auditor Agent"
    )
    ...
    review_parser.add_argument(
        "--spec", help="Path to spec.md file for compliance check", default=None
    )
    ...
    review_pr_parser = subparsers.add_parser(
        "review-pr", help="Review entire PR diff against base branch"
    )
    review_pr_parser.add_argument(
        "--base", help="Base branch (default: origin/main)", default="origin/main"
    )
    review_pr_parser.add_argument(
        "--files", nargs="*", help="Explicit list of files to review", default=None
    )
